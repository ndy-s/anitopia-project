import { ApplicationCommand, ApplicationCommandOptionData, GuildResolvable } from "discord.js";
...
export default (existingCommand: ApplicationCommand<{ guild: GuildResolvable }>, localCommand: CommandObject) => {
    ...
    const areOptionsDifferent = (existingOptions: ApplicationCommandOptionData[], localOptions: ApplicationCommandOptionData[]) => {
